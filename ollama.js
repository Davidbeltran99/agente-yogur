...
async function inferConversationIntent(contexto = {}) {
  const systemPrompt = [
    ...
    "Si el contexto indica una imagen reciente o una imagen pendiente de revisar y el cliente pide leerla o revisarla, prioriza esa intención sobre charla general.",
