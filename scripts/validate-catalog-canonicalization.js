...
async function main() {
  const aloeGarrafa = await simulateMessage("quiero 1 aloe garrafa", 1);
  ...
  const aloeLitro = await simulateMessage("quiero 1 aloe litro", 2);
  ...
  const cafeGarrafa = await simulateMessage("quiero 1 cafe garrafa 1800 ml", 3);
  ...
  const ancheta = await simulateMessage("quiero 1 ancheta", 4);
  ...
  const aloeLitroPrice = await simulateMessage("quiero Aloe Litro de 12000", 5);
  ...
  const aloeLitro1000 = await simulateMessage("quiero Aloe Litro 1000 ml", 6);
  ...
  console.log(JSON.stringify({
    ...
    tests: {
      ...
      aloeLitro: aloeLitro.pedido.productos[0].producto,
